...
public class calculos {
    ...
    int quantNumerosEscolhidos = 5; //Quantidade de números por aposta
    String prob = "";
    ...
    numero numero61 = new numero(61);
    numero numero62 = new numero(62);
    numero numero63 = new numero(63);
    numero numero64 = new numero(64);
    numero numero65 = new numero(65);
    numero numero66 = new numero(66);
    numero numero67 = new numero(67);
    numero numero68 = new numero(68);
    numero numero69 = new numero(69);
    numero numero70 = new numero(70);
    numero numero71 = new numero(71);
    numero numero72 = new numero(72);
    numero numero73 = new numero(73);
    numero numero74 = new numero(74);
    numero numero75 = new numero(75);
    numero numero76 = new numero(76);
    numero numero77 = new numero(77);
    numero numero78 = new numero(78);
    numero numero79 = new numero(79);
    numero numero80 = new numero(80);
    ...
    numero[] numeros = {numero1, numero2, numero3, numero4, numero5, numero6, numero7, numero8, numero9, numero10,
        ...
        numero61, numero62, numero63, numero64, numero65, numero66, numero67, numero68, numero69, numero70,
        numero71, numero72, numero73, numero74, numero75, numero76, numero77, numero78, numero79, numero80};
    ...
    marca marca61 = new marca(61);
    marca marca62 = new marca(62);
    marca marca63 = new marca(63);
    marca marca64 = new marca(64);
    marca marca65 = new marca(65);
    marca marca66 = new marca(66);
    marca marca67 = new marca(67);
    marca marca68 = new marca(68);
    marca marca69 = new marca(69);
    marca marca70 = new marca(70);
    marca marca71 = new marca(71);
    marca marca72 = new marca(72);
    marca marca73 = new marca(73);
    marca marca74 = new marca(74);
    marca marca75 = new marca(75);
    marca marca76 = new marca(76);
    marca marca77 = new marca(77);
    marca marca78 = new marca(78);
    marca marca79 = new marca(79);
    marca marca80 = new marca(80);
    ...
    marca[] marcas = {marca1, marca2, marca3, marca4, marca5, marca6, marca7, marca8, marca9, marca10,
        ...
        marca61, marca62, marca63, marca64, marca65, marca66, marca67, marca68, marca69, marca70,
        marca71, marca72, marca73, marca74, marca75, marca76, marca77, marca78, marca79, marca80};
    
        

    public void atualizar(int t1, int t2, int t3, int t4, int t5) {

        if (quantSorteiosRealizados > inicioSorteio) {
            sortear(t1, t2, t3, t4, t5);
        }
    ...
    public void sortear(int t1, int t2, int t3, int t4, int t5) {
        ...
        if(autoSort){
            double tempMax;
            tempMax = veTemp[79].getQuantSorteado() / quantSorteiosRealizados;
            double tempMin;
        ...
        System.out.print("\nTentativa: ");
        for(int i = 0; i < 5; i++){
            if(vetor[i] == t1 || vetor[i] == t2 || vetor[i] == t3 || vetor[i] == t4 || vetor[i] == t5){
        ...
        for(int i = 1; i < 5; i++){
            for(int b = 1; b < 5; b++){
                if(t1 == num1 || t1 == num2 || t1 == num3 || t1 == num4 || t1 == num5){
                    teste.n1++;
                    a1++;
                    m1++;
                }
                if(t2 == num1 || t2 == num2 || t2 == num3 || t2 == num4 || t2 == num5){
                    teste.n2++;
                    a2++;
                    m2++;
                }
                if(t3 == num1 || t3 == num2 || t3 == num3 || t3 == num4 || t3 == num5){
                    teste.n3++;
                    a3++;
                    m3++;
                }
                if(t4 == num1 || t4 == num2 || t4 == num3 || t4 == num4 || t4 == num5){
                    teste.n4++;
                    a4++;
                    m4++;
                }
                if(t5 == num1 || t5 == num2 || t5 == num3 || t5 == num4 || t5 == num5){
                    teste.n5++;
                    a5++;
                    m5++;
                }
        ...
        if(t1 == num1 && t2 == num2 && t3 == num3 && t4 == num4 && t5 == num5){
            teste.addCompleto();
        }
        
        double mediaTemp = 0.0f;
        mediaTemp = (a1 + a2 + a3 + a4 + a5) / 5;
        teste.calcMedia(mediaTemp);
        //analiseSorteio(t1, t2, t3, t4, t5, t6);
        
    }
    
    private void analiseSorteio(int n1, int n2, int n3, int n4, int n5){
