...
public class ProbabilidadeDeNúmero {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        File arquivo = new File("../../sorteios-sena.txt");
        try (FileReader fr = new FileReader(arquivo); BufferedReader br = new BufferedReader(fr)) {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                System.out.print("\n\n Sorteio " + quantSorteios + ": " + t1 + " " + t2 + " " + t3 + " " + t4 + " " + t5 + " " + t6);
                quantSorteios++;
                ca1.atualizar(t1, t2, t3, t4, t5, t6);
            }
            System.out.println("\n\nLinhas inseridas: " + l );
            
        }
        
        System.out.println(ca1.print());
        System.out.println(ca1.numeros());
        ca1.sortear(t1, t2, t3, t4, t5, t6);
